...
const LOCATIONS = [
  'Chandigarh Atelier — Lutyens Chandigarh',
                ...
                <div className="lg:col-span-2 px-8 py-8 space-y-8" style={{ background: 'var(--noir)', color: 'var(--ivory)' }}>
                  <div>
                    ...
                    <div className="space-y-6">
                      <Location
                        name="Chandigarh Atelier"
                        address="14, Prithviraj Road, Lutyens Chandigarh,Chandigarh — 110011"
                        mapUrl="https://maps.google.com/?q=Prithviraj+Road+Lutyens+Chandigarh"
